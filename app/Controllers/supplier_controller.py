...
def get_supplier_contact_person_by_name(name):
    return sr.get_supplier_contact_person_by_name(name)
...
def store_edited_supplier_contact_supplier(supplier_name, new_value):
    return sr.store_edited_supplier_contact_supplier(supplier_name, new_value)


def store_edited_supplier_contact_person(contact_name, new_value):
    return sr.store_edited_supplier_contact_person(contact_name, new_value)


def store_edited_supplier_contact_phone_number(phone_num, new_value):
    return sr.store_edited_supplier_contact_phone_number(phone_num, new_value)


def store_edited_supplier_contact_email(email, new_value):
    return sr.store_edited_supplier_contact_email(email, new_value)
...
def store_edited_supplier_address_name(supplier_name, new_value):
    return sr.store_edited_supplier_address_name(supplier_name, new_value)


def store_edited_supplier_address_country(supplier_address, new_value):
    return sr.store_edited_supplier_address_country(supplier_address, new_value)


def store_edited_supplier_address_state(supplier_address, new_value):
    return sr.store_edited_supplier_address_state(supplier_address, new_value)


def store_edited_supplier_address_city(supplier_address, new_value):
    return sr.store_edited_supplier_address_city(supplier_address, new_value)


def store_edited_supplier_address_zip_code(supplier_address, new_value):
    return sr.store_edited_supplier_address_zip_code(supplier_address, new_value)


def store_edited_supplier_address_street_address(supplier_address, new_value):
    return sr.store_edited_supplier_address_street_address(supplier_address, new_value)


def delete_supplier_address(supplier_name):
    return sr.delete_supplier_address(supplier_name)


def add_new_supplier_address(supplier_name, country, state, city, zip_code, street_address):
    sr.add_new_supplier_address(supplier_name, country, state, city, zip_code, street_address)
